...
<?php 
	...
	//$orderby = trim($_POST['numCommande']);
	$orderby="numCommande";
?>
		...
		<div class="accordion-heading"> 
			<div class="accordion-toggle row" data-parent="#monaccordeon" data-toggle="collapse">
				<label class="span3 offset1">
					<a href="#" id="TriNumCommandeCust" > Num Commande </a>
				</label>
				<label class="span3"><a  href="#" id="TriDateCommandeCust" > Date de commande </a></label>
				<label class="span3"><a  href="#" id="TriDateReceptionCommandeCust" > Date de reception </a></label>
			</div>
		</div>
	</div>	

	<?php
		$query_cmd 	= 'SELECT * FROM customersorders WHERE idCustomer="'.$idCustomer.'" ORDER BY '.$orderby.' DESC ';
